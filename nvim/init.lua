...
-- Allow syntax highlighting to include unlimited lines (:help 'synmaxcol')
vim.opt.synmaxcol = 0
...
-- Disable the intro message when starting nvim (:help 'shortmess')
vim.opt.shortmess:append("I", "F")
...
-- =============================================================================
-- Add the Lua reference documentation
...
vim.g.peekaboo_window = 'bo 12new'
...
vim.keymap.set("n", "ga", function() vim.cmd("<Plug>(EasyAlign)") end)
-- Start interactive EasyAlign for a motion/text object (e.g.: 'gaip')
vim.keymap.set("x", "ga", function() vim.cmd("<Plug>(EasyAlign)") end)
-- =============================================================================
...
vim.cmd('highlight TelescopeNormal ctermfg=255 ctermbg=none cterm=none gui=none')
vim.keymap.set('', '<C-T>', function() vim.cmd('Telescope') end)
vim.keymap.set('', '<C-P>', function() vim.cmd('Telescope find_files') end)
vim.keymap.set('', '<C-F>', function() vim.cmd('Telescope search_history') end)
-- =============================================================================
...
-- NOTE: Below is a demonstration of how to bind keymaps to Lua functions
vim.keymap.set("n", "<leader>r", function() print("hello world") end)

vim.keymap.set("n", "<ESC>", function() vim.cmd("let @/=''") end)
